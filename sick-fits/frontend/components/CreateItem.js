...
class CreateItem extends Component {
  ...
  uploadFile = async e => {
    ...
    const res = await fetch('https://api.cloudinary.com/v1_1/dm9gla83n/image/upload', {
      method: 'POST',
      body: data
    })
        ...
        <Form onSubmit={async e => {
          ...
          <fieldset disabled={loading} aria-busy={loading}>
            ...
            <label htmlFor="description">
              Description
              <textarea type="number" id="description" name="description" placeholder="Enter a description" required value={this.state.description} onChange={this.handleChange} />
            </label>
